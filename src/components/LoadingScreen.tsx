          ...
          <div className="relative mb-8">
            <div className="w-20 h-20 mx-auto relative">
              ...
              <div className="absolute inset-0 animate-spin" style={{ animationDuration: '3s' }}>
                ...
                <div className="absolute bottom-2 right-2 w-5 h-5 bg-gradient-to-br from-green-300 to-green-500 rounded-full opacity-70"></div>
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-6 h-6 bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-full opacity-80"></div>
                <div className="absolute bottom-2 left-2 w-5 h-5 bg-gradient-to-br from-red-300 to-red-500 rounded-full opacity-70"></div>
                <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-6 h-6 bg-gradient-to-br from-indigo-300 to-indigo-500 rounded-full opacity-80"></div>
                <div className="absolute top-2 left-2 w-5 h-5 bg-gradient-to-br from-orange-300 to-orange-500 rounded-full opacity-70"></div>
              </div>
              {/* Center */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-gradient-to-br from-sand-300 to-sand-500 rounded-full"></div>
            </div>
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 border-t border-sand-200/50 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex gap-3">
            <div className="flex-1 bg-sand-200 animate-pulse rounded-md h-10"></div>
            <div className="bg-sand-300 animate-pulse rounded-md h-10 w-16"></div>
          </div>
        </div>
      </div>
    </div>
